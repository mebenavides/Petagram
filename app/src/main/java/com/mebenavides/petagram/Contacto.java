...
public class Contacto extends AppCompatActivity {
    ...
    String  to = "mebenavides@outlook.com", subject = "Prueba", from = "mis.web.registros@gmail", cc = null, bcc = null, url = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.buttonCon);
    ...
    public void sendMail(View v){
        ...
        Toast.makeText(getBaseContext(), "Gracias por escribirnos!", Toast.LENGTH_SHORT).show();
    }
